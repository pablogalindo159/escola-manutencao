...
Route::middleware('auth')->prefix('minha-area')->name('student.')->group(function () {
    ...
    Route::get('/cursos/{course}/checkout', [StudentPaymentController::class, 'checkout'])->name('courses.checkout');
    Route::post('/cursos/{course}/criar-preference', [StudentPaymentController::class, 'criarPreference'])->name('courses.criar-preference');
    Route::post('/cursos/{course}/gerar-pix', [StudentPaymentController::class, 'gerarPix'])->middleware('throttle:5,1')->name('courses.gerar-pix');
